...
bool Shader::set_passed_color(const glm::vec4 color) {

	int passed_Color_ID = glGetUniformLocation(shader_program,"passed_Color");

	/*GLfloat arr_color[] = {color[0],color[1],color[2],color[3]};
	glUniform4fv(passed_Color_ID,1,arr_color);*/

	glUniform4fv(passed_Color_ID,1,glm::value_ptr(color));
